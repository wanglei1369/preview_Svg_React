...
export default {
    forex: {
        ...
        brokerTradingMessage:
            "Participating in the forex trading via a broker like CJCMarkets means that you have access to real-time pricing of the forex market.  You are quoted buy and sell prices   on our platform. You have the freedom to decide at which price to buy or sell, and vice versa, and you can execute a transaction at any time the relevant markets are open.",
    },
    metal: {
