...
import dataUSSharesZh from "../data/dataEURSharesZh.json"
import dataUSSharesEn from "../data/dataEURSharesEn.json"
const columnsZh = [
...
export default function USShares() {
    ...
    return (
        <>
        <Helmet>
            <title>{t("translation:seo.eurshare.Title")}</title>
            <meta name="description" content={t("translation:seo.eurshare.Description")} />
            <meta name="keywords" content={t("translation:seo.eurshare.Keywords")} />
        </Helmet>
            <LayoutSecondary bannerImg={bannerImg} pageTitle={t("translation:productsAndServices.eurshares")}>
